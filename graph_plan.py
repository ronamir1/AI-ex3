...
def independent_pair(a1, a2):
    ...
    a1_del = set(a1.get_delete())
    a2_del = set(a2.get_delete())
    # inconsistent effects
    if not a1_add.isdisjoint(a2_del):
        return False
    if not a2_add.isdisjoint(a1_del):
        return False
    # interference
    if not a1_del.isdisjoint(a2_pre):
        return False
    if not a2_del.isdisjoint(a1_pre):
        return False
    return True
